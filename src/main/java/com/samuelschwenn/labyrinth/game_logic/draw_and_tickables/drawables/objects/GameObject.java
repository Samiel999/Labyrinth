package com.samuelschwenn.labyrinth.game_logic.draw_and_tickables.drawables.objects;

import com.samuelschwenn.labyrinth.game_app.visuals.register.ImageRegister;
...
public abstract class GameObject implements Drawable, Serializable {
    ...
    public GameObject() {
        ...
        GlobalUsageController.getInstance().registerDrawable(this);
    }
    ...
    public void die(){
        GlobalUsageController.getInstance().unregisterDrawable(this);
    }
