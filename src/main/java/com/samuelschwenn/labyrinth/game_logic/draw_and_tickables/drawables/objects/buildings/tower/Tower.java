...
import com.samuelschwenn.labyrinth.game_logic.draw_and_tickables.drawables.shots.classic_shots.DefaultShot;
...
public abstract class Tower extends Building implements Tickable {
    ...
    public void die() {
        super.die();
        GlobalUsageController.getInstance().unregisterTickable(this);
    }
